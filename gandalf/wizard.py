...
def check_step_summary_rows(
    ...
    `.step(AddressForm, name="address", summary_rows=[...])`. Saying it
...
class Wizard:
    ...
    def step(
        ...
        check_step_summary_rows(form_class_or_form_view_class, context)
